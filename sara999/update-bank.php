...
<head>
<meta charset="UTF-8">
<title>Online Matka Play Update Bank Account</title>
...
.notice {
	    background-image: linear-gradient(45deg, #03A9F4, #3F51B5);
	    padding: 30px 0;
}
.lightup{
...
.result h2 {
	text-shadow: 1px 1px 1px #003161;
    font-size: 35px;
    font-weight: 700;
    color: #03A9F4;
    margin-bottom: 23px;
}
.result .na8>div:hover {
	box-shadow: 0 0 10px -3px #000;
}
.result .na8>div{
	    border: 2px solid #2196f3a1;
    border-radius: 11px;
    padding: 10px 0 0;
    background-image: radial-gradient(#fffbd4, #daefff);
}
.result .na8 {
	margin-bottom: 20px;
}
...
.charttab h3 {
    ...
    font-weight: 700;
    font-size: 24px;
    text-shadow: 1px 1px 2px #2b5fbb;
    margin-bottom: 25px;
}
.ksls a {
	transform: scale(1);
...
<a href="addfund.php" class="btn btn-primary gfdn">ADD FUND</a>
<a href="withdraw.php" class="btn btn-primary gfdn">WITHDRAW FUND</a>
    <a href="my-account.php" class="btn btn-primary gfdn">₹ 5000</a>
...
<div class="starl text-center">
	<div class="container-fluid" style="min-height: 500px;">
		<h2 style="margin-bottom: 10px;">Bank Details for Withdraw</h2><br>

		<div class="row">

			<div class="col-md-12">
	            <center>
					<form style="max-width:400px;border: 1px solid black;border-radius: 10px;margin-bottom: 25px;" action="" method="POST" onsubmit="return confirm('Are You Sure ? \n Once you Proceed You Cannot Revert.');">

            			<div class="form-group col-12 sangam fsangam">
                			<div class="cc3">
                				<label>Account Holder Name</label>
                				<input type="text" class="nnnd form-control" placeholder="Enter Account Holder Name" name="holder" value="" required>
                			</div>
                			<div class="cc3">
                				<label>Account Number</label>
                				<input type="text" class="nnnd form-control" placeholder="Enter Account Number" name="ac" value="" required>
                			</div>
                			
                			<div class="cc3">
                				<label>Bank Name</label>
                				<input type="text" class="nnnd form-control" placeholder="Enter bank name" name="bank" value="" required>
                			</div>
                			
                			<div class="cc3">
                				<label>IFSC</label>
                				<input type="text" class="nnnd form-control" placeholder="Enter IFSC" name="ifsc" value="" required>
                			</div>
                		  </div>
                		  
                		  <div class="form-group col-12 justify-content-center d-flex">
                		  	<button class="btn btn-success" type="submit" name="withdraw">Submit</button>
                		  </div>
                	</form>
