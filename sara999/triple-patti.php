...
<head>
<meta charset="UTF-8">
<title>Online Matka Play Triple Patti Play Online Matka</title>
...
<div class="myform">
	...
	<div class="container-fluid fdklslf">
	    		<h2 class="text-center">TRIPLE PATTI (10 KA 90000)</h2>
...
<div class="form-group col-md-6 col-12">
			...
			<div class="form-group col-12 numa">
				<div class="row my-rrow label-sm-text">
    						...
    						<label>000</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_000">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>111</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_111">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>222</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_222">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>333</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_333">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>444</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_444">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>555</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_555">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>666</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_666">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>777</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_777">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>888</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_888">
    					</div>
    					        				<div class="col-lg-3 col-md-4 my-sk col-6">
    						<label>999</label>
    						<input type="number" class="form-control nnnd" min="10" name="triple_patti_999">
    					</div>
    									</div>
			</div>
