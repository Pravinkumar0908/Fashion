...
<head>
    <meta charset="UTF-8">
    <title>Online Matka Play Withdrawal Amount</title>
...
<body>
    ...
    <div class="top-div fixed-top">
        ...
        <nav class="navbar navbar-light bg-light d-flex jcc dsnfds">
            ...
            <div class="d-flex djfk">
                ...
                <a href="my-account.php" class="btn btn-primary gfdn">₹ 0</a>
    ...
    <div class="starl text-center">
        <div class="container-fluid" style="min-height: 500px;">
            <h2 style="margin-bottom: 10px;">Wallet Balance : 0</h2>
            <br>
            <div class="row">
                ...
                <div class="col-md-12">
                    <center>
                        <form style="max-width:400px;border: 1px solid black;border-radius: 10px;margin-bottom: 25px;" action="" method="POST" onsubmit="return confirm('Are You Sure ? \n Once you Proceed You Cannot Revert.');">
                            ...
                            <div class="form-group col-12 sangam fsangam">
                                <div class="cc3">
                                    <label>
                                        Withdraw Money 
                                        <p style="font-size:10px;">(Min 500 Rs.)</p>
                                    </label>
                                    <input type="number" class="nnnd form-control" placeholder="Enter Amount" name="amount" min="500" max="0" required>
                                </div>
                            </div>
                        ...
                        <a style="    border: solid #fff 1px;
                            padding: 10px;
                            border-radius: 7px;
                            background: #000;" href="update-bank.php">Update Withdraw Information</a>
    ...
    <div class="my-btn">
        ...
        <a href="https://api.whatsapp.com/send?phone=919339447115&amp;text=I%20have%20Some%20query%20Regarding%20onlinematkaplay.net" class="whatapp">
