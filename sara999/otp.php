...
<head>
    <meta charset="UTF-8">
    <title>Online Matka Play Login</title>
...
<body>
    ...
    <div class="myform login">
        <div class="container-fluid fdklslf">
            <h2>User Login</h2>
            <form id="form1" class="row kls" action="" method="POST">
                <div class="col-12 aaa labein">
                    <label for="username">Enter OTP</label>
                    <input type="text" class="form-control" value="7689" id="username" name="otp" Placeholder="Your 4 Digit OTP." maxlength="4" minlength="4" required>
                </div>
